...
{  
   ...
   move_uploaded_file($temp_name, "../uploads/fimages/$image_name");
   $message = $_POST['message'];
   $last_id=$dbcon->insert_id;
   $detail_query = "INSERT INTO fthings(`f_id`,`u_id`,`item`,`item_cat`,`location`,`ddate`,`item_desc`,`img`,`message`) VALUES('$last_id','','$item_name','$item_cat','$location','$ddate','$item_desc','$image_name','$message')";
                ...
                <div class="container p-5 mt-5" id="form-container">
                    ...
                    <form class="mt-4" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-4">
                            ...
                            <input type="text" class="form-control" name="item" placeholder="Item" aria-label="Default" aria-describedby="inputGroup-sizing-default">
                        </div>
                        <div class="input-group mb-4">
                            <div class="input-group-prepend">
                        ...
                        <div class="input-group mb-4">
                            ...
                            <input type="text" name="location" placeholder="If you remember" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
                        </div>
                        <div class="input-group mb-4">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-primary" id="inputGroup-sizing-default">Date*</span>
                            </div>
                            <input type="date" name="ddate" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
                        </div>
                        <div class="input-group mb-4">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-primary">Item Description*</span>
                            </div>
                            <textarea class="form-control" name="item_desc" placeholder="It is black in color..." aria-label="With textarea"></textarea>
                        </div>
                        <div class="input-group mb-4">
                            <div class="input-group-prepend">
                        ...
                        <div class="input-group mb-4">
                            ...
                            <textarea class="form-control" name="message" placeholder="Your Message Here..." aria-label="With textarea"></textarea>
                        </div>
